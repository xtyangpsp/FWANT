...
if [ $# -lt 1 ]
        then
        echo 'USAGE: run.solver.1th_bylist.sh Gdlistfile'
        exit 1
fi

outdir="result.1th"
fnm_smooth='../block.55x53x51.1x1x1.1x1x1.smooth1th.dat'

# input list file name
list_Gd=$1 #"GDLISTTEMPLATE"
...
SOLVER=/depot/xtyang/data/codes/FWANT/Codes/InvCkb/inv.LSQR/solver_damp_smo_loc_yang
