...
!--
ierr=nf90_def_var(ncid,'Sap',NF90_FLOAT,(/Iid,Jid,Kid/),Sid(1))
ierr=nf90_def_var(ncid,'Saq',NF90_FLOAT,(/Iid,Jid,Kid/),Sid(2))
ierr=nf90_def_var(ncid,'Sbp',NF90_FLOAT,(/Iid,Jid,Kid/),Sid(3))
ierr=nf90_def_var(ncid,'Sbq',NF90_FLOAT,(/Iid,Jid,Kid/),Sid(4))
