...
! -- define variable
ierr=nf90_def_var(ncid,'Fx', NF90_FLOAT,(/ ntwfrcid, nfrcid /),vid )
ierr=nf90_def_var(ncid,'Fy', NF90_FLOAT,(/ ntwfrcid, nfrcid /),vid )
ierr=nf90_def_var(ncid,'Fz', NF90_FLOAT,(/ ntwfrcid, nfrcid /),vid )
ierr=nf90_def_var(ncid,'force_indx', nf90_int,(/ geoid, nfrcid /),vid )
ierr=nf90_def_var(ncid,'force_axis', NF90_FLOAT,(/ geoid, nfrcid /),vid )
ierr=nf90_def_var(ncid,'force_shift', NF90_FLOAT,(/ geoid, nfrcid /),vid )
ierr=nf90_def_var(ncid,'force_start_time', NF90_FLOAT,(/ nfrcid /),vid )
ierr=nf90_def_var(ncid,'force_stf_time', NF90_FLOAT,(/ ntwfrcid /),vid )
ierr=nf90_def_var(ncid,'force_stf_freq', NF90_FLOAT,(/ ntwfrcid /),vid )
...
! -- define variable
ierr=nf90_def_var(ncid,'Mxx',NF90_FLOAT,(/ntwmomid,nmomid/),vid)
ierr=nf90_def_var(ncid,'Myy',NF90_FLOAT,(/ntwmomid,nmomid/),vid)
ierr=nf90_def_var(ncid,'Mzz',NF90_FLOAT,(/ntwmomid,nmomid/),vid)
ierr=nf90_def_var(ncid,'Mxy',NF90_FLOAT,(/ntwmomid,nmomid/),vid)
ierr=nf90_def_var(ncid,'Mxz',NF90_FLOAT,(/ntwmomid,nmomid/),vid)
ierr=nf90_def_var(ncid,'Myz',NF90_FLOAT,(/ntwmomid,nmomid/),vid)
ierr=nf90_def_var(ncid,'moment_indx', nf90_int,(/ geoid, nmomid /),vid )
ierr=nf90_def_var(ncid,'moment_axis', NF90_FLOAT,(/ geoid, nmomid /),vid )
ierr=nf90_def_var(ncid,'moment_shift', NF90_FLOAT,(/ geoid, nmomid /),vid )
ierr=nf90_def_var(ncid,'moment_start_time', NF90_FLOAT,(/ nmomid /),vid )
ierr=nf90_def_var(ncid,'moment_stf_time', NF90_FLOAT,(/ ntwmomid /),vid )
ierr=nf90_def_var(ncid,'moment_stf_freq', NF90_FLOAT,(/ ntwmomid /),vid )
