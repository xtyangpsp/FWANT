...
!*****************************************************************************
!
! $Date: 2009-01-16 12:45:48 -0500 (Fri, 16 Jan 2009) $
! $Revision: 63 $
...
open(fid,file=trim(fnm_conf),status="old")
  ...
  nx1=1; ni1=nx1+3; ni2=ni1+ni-1; nx2=ni2+3
  ny1=1; nj1=ny1+3; nj2=nj1+nj-1; ny2=nj2+3
  nz1=1; nk1=nz1+3; nk2=nk1+nk-1; nz2=nk2+3
