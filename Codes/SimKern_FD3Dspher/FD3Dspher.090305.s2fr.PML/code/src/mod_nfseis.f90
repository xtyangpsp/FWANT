...
!*****************************************************************************
!
! $Date: 2009-01-16 12:45:22 -0500 (Fri, 16 Jan 2009) $
! $Revision: 62 $
...
! -- define variable
ierr=nf90_def_var(ncid, 'time', NF90_FLOAT, (/ tdimid /), tid )
...
ierr=nf90_def_var(ncid,varnm,NF90_FLOAT, &
     (/ ndimid,tdimid /), vid )
...
ierr=nf90_inq_dimid(ncid,'K',Kid)
     call nfseis_except(ierr,'K dim in grid3d_addvar')
! -- define variable
ierr=nf90_def_var(ncid, trim(aVarNm), NF90_FLOAT,(/ Iid,Jid,Kid /),varid)
