...
call MPI_SENDRECV(rho(ni2-3+1,ny1,nz1),1,DTypeXL,neigid(1,2),112, &
                  rho(ni1-3  ,ny1,nz1),1,DTypeXL,neigid(1,1),112, &
                  SWMPI_COMM,istatus,ierr)
call MPI_SENDRECV(rho(nx1,nj1  ,nz1),1,DTypeYL,neigid(2,1),121,        &
                  rho(nx1,nj2+1,nz1),1,DTypeYL,neigid(2,2),121,        &
                  SWMPI_COMM,istatus,ierr)
call MPI_SENDRECV(rho(nx1,nj2-3+1,nz1),1,DTypeYL,neigid(2,2),122, &
                  rho(nx1,nj1-3  ,nz1),1,DTypeYL,neigid(2,1),122, &
                  SWMPI_COMM,istatus,ierr)
call MPI_SENDRECV(rho(nx1,ny1,nk1  ),1,DTypeZL,neigid(3,1),131,        &
                  rho(nx1,ny1,nk2+1),1,DTypeZL,neigid(3,2),131,        &
                  SWMPI_COMM,istatus,ierr)
call MPI_SENDRECV(rho(nx1,ny1,nk2-3+1),1,DTypeZL,neigid(3,2),132, &
                  rho(nx1,ny1,nk1-3  ),1,DTypeZL,neigid(3,1),132, &
                  SWMPI_COMM,istatus,ierr)
call MPI_SENDRECV(mu (ni1  ,ny1,nz1),1,DTypeXL,neigid(1,1),211,        &
                  mu (ni2+1,ny1,nz1),1,DTypeXL,neigid(1,2),211,        &
                  SWMPI_COMM,istatus,ierr)
call MPI_SENDRECV(mu (ni2-3+1,ny1,nz1),1,DTypeXL,neigid(1,2),212, &
                  mu (ni1-3  ,ny1,nz1),1,DTypeXL,neigid(1,1),212, &
                  SWMPI_COMM,istatus,ierr)
call MPI_SENDRECV(mu (nx1,nj1  ,nz1),1,DTypeYL,neigid(2,1),221,        &
                  mu (nx1,nj2+1,nz1),1,DTypeYL,neigid(2,2),221,        &
                  SWMPI_COMM,istatus,ierr)
call MPI_SENDRECV(mu (nx1,nj2-3+1,nz1),1,DTypeYL,neigid(2,2),222, &
                  mu (nx1,nj1-3  ,nz1),1,DTypeYL,neigid(2,1),222, &
                  SWMPI_COMM,istatus,ierr)
call MPI_SENDRECV(mu (nx1,ny1,nk1  ),1,DTypeZL,neigid(3,1),231,        &
                  mu (nx1,ny1,nk2+1),1,DTypeZL,neigid(3,2),231,        &
                  SWMPI_COMM,istatus,ierr)
call MPI_SENDRECV(mu (nx1,ny1,nk2-3+1),1,DTypeZL,neigid(3,2),232, &
                  mu (nx1,ny1,nk1-3  ),1,DTypeZL,neigid(3,1),232, &
                  SWMPI_COMM,istatus,ierr)
call MPI_SENDRECV(lambda(ni1  ,ny1,nz1),1,DTypeXL,neigid(1,1),311,        &
                  lambda(ni2+1,ny1,nz1),1,DTypeXL,neigid(1,2),311,        &
                  SWMPI_COMM,istatus,ierr)
call MPI_SENDRECV(lambda(ni2-3+1,ny1,nz1),1,DTypeXL,neigid(1,2),312, &
                  lambda(ni1-3  ,ny1,nz1),1,DTypeXL,neigid(1,1),312, &
                  SWMPI_COMM,istatus,ierr)
call MPI_SENDRECV(lambda(nx1,nj1  ,nz1),1,DTypeYL,neigid(2,1),321,        &
                  lambda(nx1,nj2+1,nz1),1,DTypeYL,neigid(2,2),321,        &
                  SWMPI_COMM,istatus,ierr)
call MPI_SENDRECV(lambda(nx1,nj2-3+1,nz1),1,DTypeYL,neigid(2,2),322, &
                  lambda(nx1,nj1-3  ,nz1),1,DTypeYL,neigid(2,1),322, &
                  SWMPI_COMM,istatus,ierr)
call MPI_SENDRECV(lambda(nx1,ny1,nk1  ),1,DTypeZL,neigid(3,1),331,        &
                  lambda(nx1,ny1,nk2+1),1,DTypeZL,neigid(3,2),331,        &
                  SWMPI_COMM,istatus,ierr)
call MPI_SENDRECV(lambda(nx1,ny1,nk2-3+1),1,DTypeZL,neigid(3,2),332, &
                  lambda(nx1,ny1,nk1-3  ),1,DTypeZL,neigid(3,1),332, &
                  SWMPI_COMM,istatus,ierr)
