...
!*****************************************************************************
!
! $Date: 2009-01-16 12:56:20 -0500 (Fri, 16 Jan 2009) $
! $Revision: 69 $
...
ierr=nf90_def_var(ncid, 'coord', NF90_FLOAT, (/ gdimid,ndimid /), coordid )
     call nfseis_except(ierr,'coord var in station_skel')
ierr=nf90_def_var(ncid, 'grid', NF90_FLOAT, (/ gdimid,ndimid /), loctid )
