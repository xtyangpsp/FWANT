...
!*****************************************************************************
!
! $Date: 2009-01-16 11:21:43 -0500 (Fri, 16 Jan 2009) $
! $Revision: 54 $
...
real(SP),dimension(2,10) :: alpha,beta,rho,Q
real(SP),dimension(10) :: H
