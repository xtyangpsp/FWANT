...
%
%   A is a categorical, numeric, logical, datetime, duration, or string
%   vector, or a cell array of character vectors. G has the same length as
%   A.
%
...
%   J-th group.
%
%   FINDGROUPS treats NaNs (numeric or logical), empty "" or '' (string or
%   cell array of character vectors, respectively), <missing> values
%   (string), or <undefined> values (categorical) as missing values and
%   returns NaNs in the corresponding elements of G.
%
%   Examples:
%      % Load patients data.
...
if isa(var,'categorical')
    ...
    if isnumeric(var) || islogical(var) || isduration(var) || isdatetime(var) || isstring(var)
